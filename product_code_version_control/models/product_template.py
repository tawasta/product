...
class ProductTemplate(models.Model):
    ...
    version_code_ids = fields.One2many(
        "product.code.version", "product_tmpl_id", string="Code versions", copy=False
    )
    ...
    def _compute_product_version_code_count(self):
        for template in self:
            template.version_code_count = template.env[
        ...
        return {
            ...
            "context": {
                ...
                "default_product_id": (
                    ...
                    and self.product_variant_ids.ids[0]
                    or False
                ),
            },
            "domain": [
