odoo.define('product_cant_order.product',
    function (require) {
        "use strict";
                ...
                $.post(action, function (res) {
                    ...
                    if (results.error) {
                        ...
                        if(results.order_status == true) {
                            ...
                            $("#add_to_cart").removeClass().addClass("btn btn-primary btn-lg mt16 js_check_product a-submit d-block d-sm-inline-block");
                        }
