...
class Pricelist(models.Model):
    ...
    # This method is 100% copied from product/models/product_pricest.py
    # EXCEPT: it will skip making the currency conversion
    @api.multi
        ...
        for product, qty, partner in products_qty_partner:
            ...
            for rule in items:
                ...
                if price is not False:
                    ...
                    suitable_rule = rule
                break
            # SKIP the Final price conversion into pricelist currency
            # In the core module, here is a currency conversion
